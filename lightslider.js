        ...
        plugin = {
            ...
            pager: function () {
                ...
                if (settings.pager) {
                    ...
                    $slide.after('<div class="pager_new" style="width:'+(elSize)+'px; overflow:hidden;margin-top:-150px;"><ul class="lSPager ' + cl + '" style="margin:auto"></ul></div>');
...
//              (채광 그림) 나는 “아침 햇살이 잘 드는” 집에서 살고 싶습니다.
//              (습도 그림) 나는 “습하지 않고 쾌적한” 집에서 살고 싶습니다.
//              (방음 그림) 나는 “소음 없는 고요한” 집에서 살고 싶습니다.
//              (환기 그림) 나는 “상쾌한 공기로 숨쉴 수 있는 ” 집에서 살고 싶습니다.
//              (난방 그림) 나는 “담요가 없어도 따뜻한” 집에서 살고 싶습니다.
//              (상수도시설 그림) 나는 “언제든 따뜻한 물로 씻을 수 있는” 집에서 살고 싶습니다.
                var text_target = "상쾌한 공기로 숨쉴 수 있는";
                if(scene==0){
                    text_target = '상쾌한 공기로 숨쉴 수 있는';
                } else if(scene==1) {
                    text_target = '언제든 따뜻한 물로 씻을 수 있는';
                } else if(scene==2) {
                    text_target = '습하지 않고 쾌적한';
                } else if(scene==3) {
                    text_target = '소음 없는 고요한';
                } else if(scene==4) {
                    text_target = '아침 햇살이 잘 드는';
                } else if(scene==5) {
                    text_target = '담요가 없어도 따뜻한';
                } else {
                    text_target = '담요가 없어도 따뜻한';
                }
                
                document.getElementById("text-target").innerHTML = text_target;
            },
